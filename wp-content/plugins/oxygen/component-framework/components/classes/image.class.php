...
Class CT_Image extends CT_Component {
	...
	function add_shortcode( $atts, $content, $name ) {
		...
		if( $options['image_type'] == 1 ) {
			echo '<img id="' . esc_attr( $options['selector'] ) . '" alt="' . esc_attr( $options['alt'] ) . '" src="' . esc_attr( $options['src'] ) . '" class="' . esc_attr( $options['classes'] ) . '"'; do_action("oxygen_vsb_component_attr", $options, $this->options['tag']); echo '/>';
		} else {
			...
			echo '<img id="' . esc_attr( $options['selector'] ) . '" alt="' . esc_attr( $options['alt'] ) . '" src="' . esc_attr($src) . '" class="' . esc_attr( $options['classes'] ) . '" srcset="' . $srcset . '" sizes="100vw" '; do_action("oxygen_vsb_component_attr", $options, $this->options['tag']); echo '/>';
		}
